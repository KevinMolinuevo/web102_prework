...
function filterUnfundedOnly() {
    ...
    console.log("Unfunded Games Data:", unfundedGames);
...
function filterFundedOnly() {
    ...
    console.log("Funded Games Data:", fundedGames);
...
const totalFundsRaised = GAMES_JSON.reduce((sum, game) => sum + game.pledged, 0);
const totalGames = GAMES_JSON.length;

const formattedFunds = totalFundsRaised.toLocaleString();
...
let messageElement = descriptionContainer.querySelector("p");
if (!messageElement) {
    messageElement = document.createElement("p");
    descriptionContainer.appendChild(messageElement);
}
messageElement.textContent = message;
console.log("Updated description:", message);
